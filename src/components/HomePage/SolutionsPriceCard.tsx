...
interface SolutionsPriceCardProps {
 isFlipped: boolean
...
const SolutionsPriceCard: React.FC<SolutionsPriceCardProps> = ({ isFlipped, crrLiFront, crrLiBack, crrLiSide, list, prices }) => {
...
export default SolutionsPriceCard